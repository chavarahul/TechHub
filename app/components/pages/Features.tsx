                                ...
                                <div className=" w-[80%] h-[90%] relative  flex-col pt-10 overflow-hidden leading-8" >
                                    {
                                        data?.map((t: any, index: number) => (
                                            <div className="w-full h-[15%]  flex SideDiv items-center my-5 leading-10" key={index} style={{ transform: 'translateX(-350px)', opacity: 0 }}>
                                                ...
                                                <p className={`${poppin.className} ml-5 text-lg leading-[2.3rem]`}>{index+1+". "}{t.title}</p>
                                            </div>
                                        ))
                                    }
                                </div>
