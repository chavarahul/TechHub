  ...
  return (
    <div className="w-full p-5 min-h-[85vh] h-[85vh] flex">
            ...
            {!updateProfile ? (
              <>
                <div className="rounded-full h-[80px] w-[80px] flex-center">
                  <img src={userImage} className='w-full h-full rounded-full' alt='UserImage' />
                </div>
      ...
      <div className='w-[45%] relative h-full px-5 ml-16 overflow-y-scroll ScrollerColor'>
        ...
        {section === "" &&
          <div className=" w-full h-full relative flex-colm">
            <div className="h-1/3 w-full relative  flex-center leading-9">
              <p className={`${poppin.className} flex-center text-center px-10`}>
                Access our extensive collection of AI-generated chat data, prompt-based answers, and a diverse range of AI-created images, all available in one place to unlock the full potential of AI.
              </p>
            </div>
            <div className="h-1/4 w-full relative  flex-center leading-9">
              <div className="h-full w-[21%] relative ">
                <Image src={msg} alt="Image" className="w-full h-full rounded-[50px]"/>
              </div>
            </div>
          </div>
        }
